...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        col = [ False for i in xrange(height) ]
        self.tiles = [ col[:] for j in xrange(width) ]
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in xrange(num_trials):
        ...
        robots = [ robot_type(room, speed) for i in xrange(num_robots) ]
    ...
    return sum(trials)/float(num_trials)
...
# showPlot1("Time-steps & number of robots", "# of robots", "# of time-steps")
...
# showPlot2("Time-steps for various aspect ratios", "Aspect ratio", "Time-steps")
